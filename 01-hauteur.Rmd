...
Jeu de données `veg.csv` qui contient différentes mesures dont les hauteurs de plants de tomate, mesurées à 4 reprises :
...
La question est de savoir si les différents types d'engrais induisent des hauteurs ou augmentations de hauteur de plant significativement différentes. 
