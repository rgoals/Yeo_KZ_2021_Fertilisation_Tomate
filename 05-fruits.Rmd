...
Jeu de données `rdt` qui contient différentes mesures dont le Nombre de fruits, compté 3 fois en cours de culture, lors d'un essai de fertilisation de fin novembre 2020 à mars 2021. Dispositif expérimental en bloc de Fisher avec 6 traitements en 5 répétitions tels que décrits dans le chapitre précédent.

Un nombre moyen de fleurs est calculé pour les 4 plants centraux mesurés le même jour de la semaine en 3 séances : 

1. `fruit1` : 86 j AS, 52 j AR, semaine 8 AR
1. `fruit2` : 93 j AS, 59 j AR, semaine 9 AR 
1. `fruit3` : 100 j AS, 66 j AR, semaine 10 AR.
...
Charger le dataframe et extraire seulement les variables d'intérêt pour l'analyse du Nombre de fruits.
