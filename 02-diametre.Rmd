...
Jeu de données `veg.csv` qui contient différentes mesures dont les diamètres de plants de tomate, mesurés à 4 reprises : 
...
La question est de savoir si les différents types d'engrais induisent des diamètres ou augmentations de diamètre de plant significativement différentes. 
