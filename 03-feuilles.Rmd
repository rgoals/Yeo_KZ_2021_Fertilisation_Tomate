...
Jeu de données `veg` qui contient différentes mesures dont le nombre de feuilles de plants de tomate, compté 4 fois en cours de culture, lors d'un essai de fertilisation de fin novembre 2020 à mars 2021. Dispositif expérimental en bloc de Fisher avec 6 traitements en 5 répétitions tels que décrits dans le chapitre précédent.

Un nombre moyen de feuilles est calculé pour les 4 plants centraux mesurés le même jour de la semaine en 4 séances : 
...
Charger le dataframe et extraire seulement les variables d'intérêt pour l'analyse du nombre de feuilles.
